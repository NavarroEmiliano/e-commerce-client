...
const ProductDetails = () => {
  ...
  return (
    <div className='container mx-auto p-4 '>
        ...
        {loading ? (
          ...
          <div className='flex flex-col gap-2'>
            ...
            <div className='flex items-center gap-3 '>
              ...
              <button onClick={() => handleAddToCart(product.id)} className='border-2 border-red-600 rounded px-3 py-1 min-w-[120px]  bg-red-600 font-medium text-white hover:text-red-600 hover:bg-white'>
                Add To Cart
              </button>
            </div>
      ...
      <VerticalCardProduct category={product?.category} heading={'Recommended Product'} />
    </div>
  )
}
